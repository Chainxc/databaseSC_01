import {
  ...
  export default function VirtualLab() {
    ...
    const labData = [
      {
        name: 'กิจกรรมที่ 1 “Discover Wood Cut”      ',
        desc: ' ร่วมค้นหาเทคนิควิธีการของศิลปะภาพพิมพ์ เช่น การทำแม่พิมพ์ กระบวนการพิมพ์ ตลอดจนทดลองสร้างสรรค์ผลงานศิลปะภาพพิมพ์เทคนิคแกะไม้ (wood cut)',
        place : 'สถานที่จัดกิจกรรม: ห้องปฏิบัติการศิลปะ 1109',
        type : 'รูปแบบการจัด :จัดเป็นรอบ รอบละ 30 นาที รับรอบละไม่เกิน 12 คน วันละ 4 รอบ ดังนี้รอบเช้า 10.30-11.00 น. และ 11.30-12.00 น.รอบบ่าย 13.00 -13.30 น. และ 14.00-14.30 น.',
