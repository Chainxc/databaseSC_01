  ...
  const labData = [
    {
      ...
      desc: ' เป็นรูปแบบการเล่นบอร์ดเกมคล้ายเกมเศรษฐี โดยผู้เล่นจะทำการทอยลูกเ<br>ต๋า และใช้หมากเดินไปที่ช่องต่างๆบนกระดาน <br>และตอบคำถามที่สอดแทรกความรู้วิชาเคมี หากตอบถูกจะได้รับคะแนน รวมคะแนนเพื่อหาผู้ชนะ',
      img: 'chema1p1.webp',
      button: [
        {
          name: 'Virtual Lab',
