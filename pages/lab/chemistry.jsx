    ...
    const labData = [
      {
        ...
        desc: 'เป็นรูปแบบการเล่นบอร์ดเกมคล้ายเกมเศรษฐี โดยผู้เล่นจะทำการทอยลูกเต๋า และใช้หมากเดินไปที่ช่องต่างๆบนกระดาน และตอบคำถามที่สอดแทรกความรู้วิชาเคมี ',
        award: 'หากตอบถูกจะได้รับคะแนน \n รวมคะแนนเพื่อหาผู้ชนะสถานที่ : 3503\nรูปแบบการจัด : จัดเป็นรอบๆ รอบละ 20นาที \n วัสดุอุปกรณ์ : บอร์ด และการ์ด (ทำจากกระดาษและฟิวเจอร์บอร์ด)\nจำนวนผู้เข้าร่วม : 20 คน\nของรางวัล : ลูกอม',
        img: 'chema1p1.webp',
        button: [
          {
            name: 'Virtual Lab',
      ...
      {
        name: 'กิจกรรมที่ 2 Discover the power of visible light',
        desc: 'การหาความเข้มข้นที่แท้จริงของสารละลาย ผ่านการวัดค่า absorbance และ full spectrum(จาก data logger) ผ่านนักสืบไขคดีสถานที่ : 3601รูปแบบการจัด : walk-in วัสดุอุปกรณ์ : data logger, เกลือ, น้ำกลั่น, สีผสมอาหาร, cuvette, บีกเกอร์, ปิเปต<br>จำนวนผู้เข้าร่วม : ไม่จำกัด',
        img: 'chema2p1.webp',
        button: [
          {
            name: 'Virtual Lab',
