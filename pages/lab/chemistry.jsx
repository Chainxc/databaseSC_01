    ...
    const labData = [
      {
        ...
        desc: ' เป็นรูปแบบการเล่นบอร์ดเกมคล้ายเกมเศรษฐี โดยผู้เล่นจะทำการทอยลูกเต๋า และใช้หมากเดินไปที่ช่องต่างๆบนกระดาน และตอบคำถามที่สอดแทรกความรู้วิชาเคมี หากตอบถูกจะได้รับคะแนน /n รวมคะแนนเพื่อหาผู้ชนะสถานที่ : 3503/nรูปแบบการจัด : จัดเป็นรอบๆ รอบละ 20นาที /nวัสดุอุปกรณ์ : บอร์ด และการ์ด (ทำจากกระดาษและฟิวเจอร์บอร์ด)/nจำนวนผู้เข้าร่วม : 20 คน/nของรางวัล : ลูกอม',
        img: 'chema1p1.webp',
        button: [
          {
            name: 'Virtual Lab',
