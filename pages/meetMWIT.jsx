...
กิจกรรมน้องถาม-พี่ตอบ คือ กิจกรรมที่ให้รุ่นน้องเข้ามาคุยกับรุ่นพี่แบบเดี่ยวและกลุ่ม topic การคุยจะเป็นการตอบคำถามที่น้องสงสัย การเตรียมตัวสอบเข้าของรุ่นพี่ และไลฟ์สไตล์ความเป็นอยู่ในโรงเรียน (เขียนคำบรรยายในพาสฟอร์ตไว้ว่า : กิจกรรมที่เปิดโอกาสให้น้อง ๆ มาคุยกับรุ่นพี่ตัวจริงเสียงจริง มาคุยกัน อย่าปล่อยให้รุ่นพี่เหงา
นะ !)


เอกสารที่ต้องเตรียมก่อนเข้างาน : ไม่ต้องเตรียมอะไรเลย มาแค่ตัวและหัวใจ
...
จำนวนคนที่รับในแต่ละวัน : max 144 คน (7 คนต่อรอบ)
